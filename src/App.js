...
function App() {
  ...
  return (
   ...
   <LoadingBar height={5}
      ...
      />
      <Routes>
        <Route exact path='/' element={<Home key="1" setId={setId} setProgress={setProgress}/>}/>
        ...
        <Route exact path="/search" element={<Search key="6" setProgress={setProgress} setId={setId} searchQuery={searchQuery}/>}/>
